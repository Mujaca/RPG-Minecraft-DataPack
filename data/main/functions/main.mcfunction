...
execute as @e at @s if score @s damagedealt > @s null run function healthsystem:strength
execute as @e at @s if score @s damage > @s null run function healthsystem:health
