...
execute as @s[nbt={SelectedItem:{id:"minecraft:ocelot_spawn_egg"}}] run tag @s add hatching
execute as @s[nbt={SelectedItem:{id:"minecraft:ocelot_spawn_egg"}},tag=!haspet,tag=!hasegg] run scoreboard players set @s hatchtime 12000
execute as @s[nbt={SelectedItem:{id:"minecraft:ocelot_spawn_egg"}},tag=!haspet] run tag @s add hasegg
...
execute if score @s hatchtime = @s null if entity @s[nbt={SelectedItem:{id:"minecraft:fox_spawn_egg"}}] run summon minecraft:fox ~ ~ ~ {NoGravity:1b,NoAI:1b,CanPickUpLoot:0b,Tags:["pet"],CustomName:'{"text":"Fox Pet"}',CustomNameVisible:1b,Age:-1000000000}
...
execute if score @s hatchtime = @s null if entity @s[nbt={SelectedItem:{id:"minecraft:cow_spawn_egg"}}] run summon minecraft:mooshroom ~ ~ ~ {NoGravity:1b,CanPickUpLoot:0b,Tags:["pet"],Sleeping:1b,CustomName:'{"text":"Pilzkuh Pet"}',CustomNameVisible:1b,Age:-1000000000}
...
execute if score @s hatchtime = @s null if entity @s[nbt={SelectedItem:{id:"minecraft:ocelot_spawn_egg"}}] run summon minecraft:cat ~ ~ ~ {NoGravity:1b,CanPickUpLoot:0b,Tags:["pet"],Sleeping:1b,CustomName:'{"text":"Ocelot Pet"}',CustomNameVisible:1b,Age:-1000000000}
execute if score @s hatchtime = @s null if entity @s[nbt={SelectedItem:{id:"minecraft:ocelot_spawn_egg"}}] store result score @e[type=minecraft:cat,tag=pet,distance=..1,tag=!gotid] petid run scoreboard players get current petid
execute if score @s hatchtime = @s null if entity @s[nbt={SelectedItem:{id:"minecraft:ocelot_spawn_egg"}}] store result score @s petid run scoreboard players get current petid
execute if score @s hatchtime = @s null if entity @s[nbt={SelectedItem:{id:"minecraft:ocelot_spawn_egg"}}] run tag @e[type=cat,tag=pet,distance=..1,tag=!gotid] add gotid
execute if score @s hatchtime = @s null if entity @s[nbt={SelectedItem:{id:"minecraft:ocelot_spawn_egg"}}] run scoreboard players set @s sneaktime 0
execute if score @s hatchtime = @s null if entity @s[nbt={SelectedItem:{id:"minecraft:ocelot_spawn_egg"}}] run clear @s minecraft:ocelot_spawn_egg 1
