...
execute if score @s hatchtime = @s null if entity @s[nbt={SelectedItem:{id:"minecraft:fox_spawn_egg"}}] run summon minecraft:fox ~ ~ ~ {NoGravity:1b,NoAI:1b,CanPickUpLoot:0b,Tags:["pet"],Sleeping:1b,CustomName:'{"text":"Fox Pet"}',CustomNameVisible:1b}
...
execute if score @s hatchtime = @s null if entity @s[nbt={SelectedItem:{id:"minecraft:turtle_spawn_egg"}}] run summon minecraft:turtle ~ ~ ~ {NoGravity:1b,NoAI:1b,CanPickUpLoot:0b,Tags:["pet"],Sleeping:1b,CustomName:'{"text":"Schildkröten Pet"}',CustomNameVisible:1b}
...
execute if score @s hatchtime = @s null if entity @s[nbt={SelectedItem:{id:"minecraft:panda_spawn_egg"}}] run summon minecraft:panda ~ ~ ~ {NoGravity:1b,NoAI:1b,CanPickUpLoot:0b,Tags:["pet"],Sleeping:1b,CustomName:'{"text":"Panda Pet"}',CustomNameVisible:1b}
...
execute if score @s hatchtime = @s null if entity @s[nbt={SelectedItem:{id:"minecraft:cow_spawn_egg"}}] run summon minecraft:mooshroom ~ ~ ~ {NoGravity:1b,NoAI:1b,CanPickUpLoot:0b,Tags:["pet"],Sleeping:1b,CustomName:'{"text":"Pilzkuh Pet"}',CustomNameVisible:1b}
